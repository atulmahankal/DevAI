...
3. Claim task with `@opencode` `#YYYYMMDD-HHMMSS` tag
4. Create memory file: `.ai/memory/YYYYMMDD_HHMMSS_opencode.md`
...
2. **Claim Tasks**: Add `@opencode` tag to tasks you're working on
...
### Memory File Naming
```
.ai/memory/YYYYMMDD_HHMMSS_opencode.md
```

### Task Format
```markdown
- [ ] Pending task
- [•] Task name `@opencode` `#20241229-143022`  ← In Progress
- [✓] Completed task ~~@opencode~~ ~~#20241229-143022~~
```

## OpenCode-Specific Notes
- Use OpenCode's SST integration for serverless deployments
- Leverage codebase context for accurate code generation
- Follow project patterns from `.ai/CODING_GUIDELINES.md`
- Reference `Implementation/PROJECT_CONTEXT.md` for tech stack
